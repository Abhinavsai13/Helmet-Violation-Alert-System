...
# --- CONFIGURATION ---
YOLO_MODEL = "best.pt"
# Directory containing known face images named as <roll_number>.png
KNOWN_FACES_DIR = r"C:\Users\known_faces"
# CSV file with columns: Roll Number, Email
...
def send_violation_email(roll_number):
    ...
    # if email not found, log warning and skip sending
    if not to_email:
...
while True:
    ...
    # If head detected, proceed with face recognition
    if head_detected:
